    ...
    return ( 
        <div className="flex items-center h-[100vh]">
            <div className="flex-1 md:text-left">
                <h1 data-heading="discover" className="md:text-6xl text-4xl text-center text-green-600 font-bold">
                    Discover with Dhania:
                </h1>
                <h1 data-heading="revolutionary" className="md:text-6xl text-4xl text-center">
                    Revolutionary AI-Powered Search for:
                </h1>
                <div data-heading="typing" className="text-center">
                    <Typed
